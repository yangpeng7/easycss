  ...
  easyPanel.contentWindow.postMessage(
    {
      ...
      data: JSON.stringify({
        width: cpStyle.width,
        height: cpStyle.height,
        marginTop: cpStyle.marginTop,
        marginRight: cpStyle.marginRight,
        marginBottom: cpStyle.marginBottom,
        marginLeft: cpStyle.marginLeft,
        paddingTop: cpStyle.paddingTop,
        paddingRight: cpStyle.paddingRight,
        paddingBottom: cpStyle.paddingBottom,
        paddingLeft: cpStyle.paddingLeft,
        boxShadow: cpStyle.boxShadow,
        background: cpStyle.background,
        border: cpStyle.border,
        borderRadius: cpStyle.borderRadius,
      }),
    },
    "*"
  );
